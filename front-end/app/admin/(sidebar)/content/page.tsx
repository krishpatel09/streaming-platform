      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-500">
            Manage your movies, TV shows, and individual episodes.
          </p>
        </div>
        
        {/* Step 1: Upload Form Dialog */}
        <Dialog open={showUploadForm} onOpenChange={setShowUploadForm}>
          ...
          <DialogContent className="max-w-5xl h-[90vh] overflow-y-auto bg-white border-zinc-200 p-0">
            <DialogHeader className="sr-only">
              <DialogTitle>Upload Video</DialogTitle>
              <DialogDescription>
                Quickly upload a new video to your library.
              </DialogDescription>
            </DialogHeader>
            <div className="p-6">
              <VideoUploadForm 
        ...
        {/* Step 2: Processing Status Dialog */}
        <Dialog open={showStatus} onOpenChange={setShowStatus}>
          <DialogContent className="max-w-5xl h-[90vh] overflow-y-auto bg-white border-zinc-200 p-0">
            <DialogHeader className="sr-only">
              <DialogTitle>Processing Video</DialogTitle>
              <DialogDescription>
                Viewing the pipeline status for your video upload.
              </DialogDescription>
            </DialogHeader>
            <div className="p-6">
              {uploadData && (
        ...
        {[
          {
            title: "Movies",
            count: "842 Movies",
            desc: "Manage feature films and trailers.",
            icon: Film,
          ...
          },
          {
            title: "TV Series",
            count: "156 Shows",
            desc: "Organize series and seasons.",
            icon: Tv,
          ...
          },
          {
            title: "Episodes",
            count: "3,420 Eps",
            desc: "Upload and link individual episodes.",
            icon: Play,
          ...
          <Card
            key={i}
            className="bg-white border-zinc-200 shadow-sm hover:shadow-md transition-all group border-b-4 border-b-transparent hover:border-b-indigo-500"
          >
            <CardHeader>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-500 font-medium">
              12 files currently being transcoded to 4K / HDR.
            </p>
          </div>
        </div>
        <Button
